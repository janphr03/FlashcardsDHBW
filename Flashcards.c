...
void saveFlashcardsToFile() {
    ...
    while (1) {
        ...
        printf("Bitte geben Sie einen neuen Dateipfad ein (oder \"cancel\" zum Abbrechen): ");
...
void loadConfig(char *path) {
    ...
    if (config == NULL) {
        ...
        // Hier gehen wir davon aus, dass der Nutzer einen Ordner angegeben hat.
        // Hängen Sie den Dateinamen "FlashcardsMemory.json" an.
#ifdef _WIN32
